...
const RadialPlot = ({ data, setDataPoint }) => {
   const updateDataPoint = (ctx, mouseInfo, dataContainer) => {
      ...
      const radAdjust = Math.floor(
         ((clickLocation.x - origin.x) / lengthX) * dataContainer.imax
      );
      setDataPoint({ x: radAdjust, y: dataContainer.dataPoint.y });
   };
